...
async function loadAll() {
  try {
    ...
    let sections = [];
    try {
      const sc = await apiGet("sections");
...
function StoryPage({
  ...
  }, lang === "hi" ? "पक्ष बदलने को स्वाइप करें ⇄" : "swipe to change side ⇄")), (counts.international > 0 || counts.unrated > 0) && /*#__PURE__*/React.createElement("p", {
    className: `mb-3 text-[11px] leading-relaxed ${t.tf} ${isHi(lang)}`
  }, STR[lang].nonVoting), /*#__PURE__*/React.createElement("div", {
...
function TopicsHub({
  ...
  }, lang === "hi" ? "सभी विषय" : "All Topics"), /*#__PURE__*/React.createElement("div", {
...
function TopicPage({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: `mb-4 inline-flex items-center gap-1.5 eyebrow ${t.ts} hover:${t.tp} ${isHi(lang)}`,
    style: {
      letterSpacing: lang === "hi" ? 0 : ".1em"
    }
  }, /*#__PURE__*/React.createElement(ArrowLeft, {
...
function SectionsHub({
  ...
  const LEAD_N = 4;
  const lead = sections.slice(0, LEAD_N),
    rest = sections.slice(LEAD_N);
  ...
  const allTopicsLink = /*#__PURE__*/React.createElement("div", {
    ...
    className: `eyebrow ${t.ts} hover:${t.tp} ${isHi(lang)}`,
    style: {
      letterSpacing: lang === "hi" ? 0 : ".1em"
    }
  ...
  if (!sections.length) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: `mt-10 py-16 text-center ${t.tf} ${isHi(lang)}`
    }, STR[lang].noStories), allTopicsLink);
  }
  return /*#__PURE__*/React.createElement("div", {
    className: "mx-auto max-w-[1000px] px-4 sm:px-8 py-10"
  }, /*#__PURE__*/React.createElement("h1", {
  ...
  }, rest.map(s => /*#__PURE__*/React.createElement("a", {
    key: s.key,
    href: "/section/" + s.slug,
    onClick: e => {
      e.preventDefault();
...
function parsePath() {
  ...
  if (seg.length === 1 && ["blindspot", "topics", "all-topics", "sources", "about", "contact", "privacy", "support", "login", "settings", "account", "saved", "lens", "storylines", "my-paksh"].includes(seg[0])) return {
    view: seg[0]
  };
  return {
    view: "404"
...
function PakshApp() {
  ...
  /* 6.3B.8 — story and blindspot resolve their OWN loading state, each with a
    ...
    t: t
  }) : route.view === "topics" ? /*#__PURE__*/React.createElement(SectionsHub, {
    ...
    goSection: goSection,
    go: go
  }) : route.view === "all-topics" ? /*#__PURE__*/React.createElement(TopicsHub, {
